(function () {
  ...
  var SITE = [
    ...
    { n: 2, dir: "phase-02-software-engineering", name: "Software engineering foundations", built: false, topics: [
    ...
    { n: 3, dir: "phase-03-full-stack", name: "Full-stack for FDEs", built: false, topics: [
    ...
    { n: 4, dir: "phase-04-cloud-infrastructure", name: "Cloud & infrastructure", built: false, topics: [
    ...
    { n: 5, dir: "phase-05-devops-sre", name: "DevOps, SRE & observability", built: false, topics: [
    ...
    { n: 6, dir: "phase-06-enterprise-integration", name: "Enterprise integration", built: false, topics: [
    ...
    { n: 7, dir: "phase-07-ai-llm-deployment", name: "AI/LLM deployment for FDEs", built: false, topics: [
    ...
    { n: 8, dir: "phase-08-system-design", name: "System design for FDE scenarios", built: false, topics: [
    ...
    { n: 9, dir: "phase-09-customer-consulting", name: "Customer & consulting skills", built: false, topics: [
    ...
    { n: 10, dir: "phase-10-business-product", name: "Business & product thinking", built: false, topics: [
    ...
    { n: 11, dir: "phase-11-security-governance", name: "Security & governance", built: false, topics: [
    ...
    { n: 12, dir: "phase-12-capstones", name: "Capstone: the FDE engagement", built: false, topics: [
